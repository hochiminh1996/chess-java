...
public class ChessPosition {
	...
	protected Position toPosition() {
		// vai pegar uma coordenada que foi inserida com letra (coluna) e linha (número)
		// e
		// converter para uma posição que tenha apenas números na linha e coluna
		// (posição de matriz)
		 ...
		 * 
		 * Logo, as coordenadas : b8 retornará as posições de matriz : linha 0 e coluna
		 * 1. Lembre-se: as coordenadas começam do zero
		 * 
		 * 
		 * Ex: 2. COLUNA A, LINHA 1 => 8-1 = 7(LINHA), A-A = 0 (COLUNA)
		 */

	}

	// agora vai pegar uma posição de matriz e converte-lá para uma posição de
	// xadrez (com letras e colunas)
	protected static ChessPosition fromPosition(Position position) {
		return new ChessPosition((char) ('a' + position.getColumn()), 8 - position.getRow());

		// ele vai chamar o construtor e passar os parâmetros já convertidos para
		// valores de matriz.
